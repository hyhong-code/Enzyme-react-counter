...
test("renders alert when counter is 0 and decrement button clicked", () => {
  const wrapper = setup(null, { countet: 0 });
...
test("doesn't render alert when increment button is clicked", () => {
  // let alert show
